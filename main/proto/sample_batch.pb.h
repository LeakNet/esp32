...
#ifndef PB_SAMPLE_BATCH_PB_H_INCLUDED
#define PB_SAMPLE_BATCH_PB_H_INCLUDED
#include <pb.h>
#include "sys/types.h"
...
X(a, STATIC,   REQUIRED, FLOAT,    flow,              2) \
...
#define SAMPLE_BATCH_PB_H_MAX_SIZE               SampleBatch_size
